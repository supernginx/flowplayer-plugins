...
package org.flowplayer.view {
    ...
    import org.flowplayer.model.BufferingOverlay;
    ...
    public class PlayButtonOverlayView extends AbstractSprite implements Plugin {
        ...
        private var _buffering:BufferingAnimation;
...
//			eventSupport.onBufferEmpty(startBuffering);
		...
		private function createChildren():void {			
			_buffering = new BufferingAnimation(_play);
		...
		protected override function onResize():void {
			...
			_buffering.setSize(width, height);
...
//			_screen.hidePlay();
		...
		public function showButton(event:ClipEvent = null, label:String = null):void {
			...
			if (! _button) return;
			if (_buffering.parent == this) return;
