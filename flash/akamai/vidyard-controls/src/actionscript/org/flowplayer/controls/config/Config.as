...
package org.flowplayer.controls.config {
	...
	public class Config {
		...
		public function get scrubberConfig():ScrubberConfig {
			...
			var dragConfig:TooltipButtonConfig = draggerConfig;

			dragConfig.setTooltipEnabled(tooltips.scrubber);
			config.setDraggerButtonConfig(dragConfig);
		...
		public function get volumeConfig():SliderConfig {
			...
			var dragConfig:TooltipButtonConfig = draggerConfig;
			dragConfig.setTooltipEnabled(tooltips.volume);
        ...
        public function get draggerConfig():TooltipButtonConfig {
			var config:TooltipButtonConfig = new TooltipButtonConfig();
			if (_style['draggerColor']) config.setColor(_style['draggerColor']);
            if (_style['draggerOverColor']) config.setOverColor(_style['draggerOverColor']);
            if (_style['draggerOffColor']) config.setOffColor(_style['draggerOffColor']);
            if (_style['draggerColor']) config.setOnColor(_style['draggerColor']);
